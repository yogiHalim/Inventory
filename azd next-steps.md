...
- `AZURE_COSMOS_MONGODB_CONNECTION_STRING` environment variable is configured in [Inventory.bicep](./infra/app/Inventory.bicep) to connect to the MongoDB database. Modify this variable to match your application's needs.
...
- [app/Inventory.bicep](./infra/app/Inventory.bicep) - Azure Container Apps resources to host the 'Inventory' service.
- [app/db-cosmos.bicep](./infra/app/db-cosmos.bicep) - Azure Cosmos DB (MongoDB) to host the '' database.
